...
impl Curve for Bls381{
    ...
    const SCALAR_FIELD: &'static str = "52435875175126190479447740508185965837690552500527637822603658699938581184513";
    const FQ_BYTES_LENGTH: usize = 0;
    type Point = [u8;96];
    fn fq_bytes_length() ->usize{ 48 }
...
fn test_bls381_mul() {
    ...
    // (a·G)·b = (a * b)·G = c·G
    assert_eq!(G1Affine::from(G1Affine::from(g * a) * b).to_uncompressed(),
...
fn test_bls381_pairing() {
    ...
    pairings.iter().enumerate().for_each(
        |(i,(a,b))|{
