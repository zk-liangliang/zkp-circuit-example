...
impl<'a, E: JubjubEngine> Circuit<E> for ConfidentialAccount<'a, E> {
    fn synthesize<CS: ConstraintSystem<E>>(self, cs: &mut CS) -> Result<(), SynthesisError>
    {
        ...
        // hash is now is just an array of 256 bits. Our field is limited in number of bits that input can represent, so we need to truncate some of the bits

        // for convenience we reverse the array, trucrate it and interpret the rest as LE decomposition of the field element
